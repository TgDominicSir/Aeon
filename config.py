...
# Recommended for persisting settings and task history. Essential for some features.
DATABASE_URL = ""
...
LOG_CHAT_ID = 0  # Chat ID for sending logs
...
# Queueing system
QUEUE_ALL = 12  # Max concurrent tasks (upload + download)
